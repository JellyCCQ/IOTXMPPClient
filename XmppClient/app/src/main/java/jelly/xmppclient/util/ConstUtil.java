...
public class ConstUtil {
     ...
     * 注册用户名
     */
    public static final String REG_KEY_NAME = "reg_username";
    /**
     * 注册密码
     */
    public static final String REG_KEY_PWD = "reg_password";
    /**
     * 注册确认密码
     */
    public static final String REGCONFIRM_KEY_PWD = "reg_confirmpassword";
    /**
     * 登录状态广播过滤器
     */
